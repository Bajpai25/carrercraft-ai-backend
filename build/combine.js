...
exports.typeDefs = (0, apollo_server_express_1.gql) `${user_1.userschema}${resume_2.resumeschema}${cover_letter_2.coverletterschema}${job_2.jobschema}${schema_1.coldemailschema}`;
exports.resolvers = {
    ...
    Mutation: Object.assign(Object.assign(Object.assign(Object.assign({}, user_2.userResolver.Mutation), resume_1.resumeResolver.Mutation), cover_letter_1.CoverResolver.Mutation), job_1.jobResolver.Mutation)
};
